package com.llm.ai.project.debuggingAI.debug.controller;
...
public class UnitTestGeneratorController {
    ...
    public String generateAllTests() {
        String controllerClassName = "com.llm.ai.project.debuggingAI.ecosystem.controller.EcosystemTestController";
    ...
    public String generateServiceTest() {
        String serviceClassName = "com.llm.ai.project.debuggingAI.debug.service.TestService";
    ...
    public String generateRepositoryTests(@RequestParam(required = false) String className) {
        if (className == null || className.isEmpty()) {
            className = "com.llm.ai.project.debuggingAI.debug.repository.TestRepository";
        }
    ...
    public String generateModelTest() {
        String modelClassName = "com.llm.ai.project.debuggingAI.debug.model.TestEntity";
